...
const ALL_WILAYAS = [
  ...
  [44, "Aïn Defla", 800],
  [45, "Naâma", 1100],
  [46, "Aïn Témouchent", 1000],
  [47, "Ghardaïa", 1100],
  [48, "Relizane", 1000],
  [49, "Timimoun", 1300],
  [50, "Bordj Badji Mokhtar", 1500],
  [51, "Ouled Djellal", 1100],
  [52, "Béni Abbès", 1200],
  [53, "In Salah", 1400],
  [54, "In Guezzam", 1500],
  [55, "Touggourt", 1100],
  ...
  [59, "Ain Temouchent (Hassasna)", 1000],
  [60, "El Eulma", 900],
  [61, "Bir El Djir", 900],
  [62, "Hammam Bou Hadjar", 1000],
  [63, "Salah Bay", 900],
  [64, "Ain Oussera", 950],
  [65, "Robbah", 1100],
  [66, "Mechraa Sfa", 950],
...
if (wilayaCount === 0) {
  const insert = db.prepare(
    "INSERT INTO wilayas (id, name, shipping_price) VALUES (?, ?, ?)",
  );
...
const insertOrIgnore = db.prepare(
  "INSERT OR IGNORE INTO wilayas (id, name, shipping_price) VALUES (?, ?, ?)",
);
